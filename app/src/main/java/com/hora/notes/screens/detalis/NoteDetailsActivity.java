package com.hora.notes.screens.detalis;
...
//Интересная идея. упрощает взаимодействие и сокращает повторение кода
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                if (editText.getText().length() > 0) {
                    ...
                    Toast.makeText(this,"Заполните пусто поле",Toast.LENGTH_LONG).show();
                }
                break;
            default:
